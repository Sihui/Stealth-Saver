                ...
                DialogGenerator.makeSelectListDialog(getResources().getString(R.string.speechActivationHeading), 
                        SpeechRecognitionPlay.this, activationMethod, new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which)
                            {
                                ...
                                Log.d("LOG - BEFORE IF", "b");
                               /* if(speechActivator instanceof WordActivator){
                                    SharedPreferences pref = getSharedPreferences("Setting", Context.MODE_PRIVATE);
                                    String magicWord = pref.getString("MAGICWORD","please hurt me");
                                    Log.d("LOG - MW", magicWord);
                                    //if(!magicWord.isEmpty())
                                    speechActivator =new WordActivator( SpeechRecognitionPlay.this, finalContext, magicWord.split(" "));
                                    //speechActivator =new WordActivator( SpeechRecognitionPlay.this, finalContext, "please","hurt","me");
